...
# Tab Navigator
 ...
 The Tab navigator is a little bit more complex than the other navigators. Since it is the root navigation after the mainstack. This navigator creates a listener object that is constantly listening no matter the screen from here on out.
...
as well as expo
[Click Here](https://docs.expo.dev/versions/latest/sdk/notifications/)
