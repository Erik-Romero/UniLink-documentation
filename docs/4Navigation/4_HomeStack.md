...
This stack is populated only with all the screens that the home tab needs to be aware of, however it has an additional drawer navigator to pull from as well.
