...
The `ProjectsScreen` is the screen that handles creating or joining a project. There are options for selecting a required set of skills for a user to have before joining a project.  
...
## Sets up all initiail variables and states 
```js
const CollaborationScreen = () => {
  ...
  ## Functions for fetchking skills and projects from firebase database
...
## Renders cards for deleting a project 
```js
